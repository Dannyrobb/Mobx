...
export interface PixelIconProps extends SVGIconProps {}

export const PixelIcon: React.FunctionComponent<PixelIconProps> = (props) => {
  return (
    <SvgIcon {...{ width: 16, height: 16, viewBox: '0 0 32 32', ...props }}>
      <rect id="pixelIcon" fill="none" width="32" height="32" />
