...
export interface CheckMarkWhiteFilledIconProps extends SVGIconProps {}

export const CheckMarkWhiteFilledIcon: React.FunctionComponent<CheckMarkWhiteFilledIconProps> = (props) => {
  return (
