...
export interface SubAffilatesIconProps extends SVGIconProps {}

export const SubAffiliatesIcon: React.FunctionComponent<SubAffilatesIconProps> = (props) => {
  return (
    <SvgIcon {...{ width: 16, height: 16, viewBox: '0 0 32 32', ...props }}>
      <rect id="subAffiliateIcon" fill="none" width="32" height="32" />
