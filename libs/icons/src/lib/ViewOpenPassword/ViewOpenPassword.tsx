...
export interface ViewOpenIconProps extends SVGIconProps {}

export const ViewOpenPasswordIcon: React.FunctionComponent<ViewOpenIconProps> = (props) => {
  return (
    <SvgIcon {...{ width: 16, height: 16, viewBox: '0 0 32 32', ...props }}>
      <rect id="View_Open" fill="none" width="16" height="16" />
      <path
