...
export interface WorldIconProps extends SVGIconProps {}

export const WorldIcon: React.FunctionComponent<WorldIconProps> = (props) => {
  return (
    <SvgIcon {...{ width: 16, height: 16, viewBox: '0 0 32 32', ...props }}>
      <rect id="worldIcon" fill="none" width="32" height="32" />
